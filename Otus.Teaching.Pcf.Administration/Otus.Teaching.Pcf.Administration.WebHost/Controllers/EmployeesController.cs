...
namespace Otus.Teaching.Pcf.Administration.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet("{id:guid}")]
        public async Task<ActionResult<EmployeeResponse>> GetEmployeeByIdAsync(ObjectId id)
        {
        ...
        public async Task<IActionResult> UpdateAppliedPromocodesAsync(ObjectId id)
        {
            var employee = await _employeeRepository.GetByIdAsync(id);
